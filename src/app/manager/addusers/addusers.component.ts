...
export class AddusersComponent implements OnInit {
	...
	selectedShift: string = "24 horas"; // Hardcodeado por las prisas
...
// tslint:disable-next-line: max-line-length
				this.user = new usermuir(this.person, this.passwordGenerator(idstudent.Numero, this.person.name, this.person.fatherName), environment.instanceName, this.orgName, this.codegroup, this.numberrequest, this.studentsinglemuir, this.typecorporate, this.selectedProject, this.selectedShift);
...
// tslint:disable-next-line: max-line-length
				this.userexternal = new userexternalmuir(this.person, this.passwordGenerator(idstudent.Numero, this.person.name, this.person.fatherName), environment.instanceName, this.orgName, this.codegroup, this.numberrequest, this.studentexternalmuir);
...
// tslint:disable-next-line: max-line-length
			this.user = new usermuir(this.personsinglemuir, this.passwordGenerator(0, this.personsinglemuir.name, this.personsinglemuir.fatherName), environment.instanceName, this.orgName, this.codegroup, this.numberrequest, this.studentsinglemuir, this.typecorporate, this.selectedProject, this.selectedShift);
...
// tslint:disable-next-line: max-line-length
			this.userexternal = new userexternalmuir(this.personsinglemuir, this.passwordGenerator(0, this.personsinglemuir.name, this.personsinglemuir.fatherName), environment.instanceName, this.orgName, this.codegroup, this.numberrequest, this.studentexternalmuir);
